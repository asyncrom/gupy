...
The hull was designed on [FreeCad](https://www.freecad.org/) with a Python macro. Code here: [macro_hull_skeleton.fcmacro](macro_hull_skeleton.fcmacro) (french).
...
The skeleton was cut in plywood with a [laser cutter](https://www.hatlab.fr/equipement/decoupe-laser/) at the [HATLAB](https://www.hatlab.fr).
